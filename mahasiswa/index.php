			...
			<tbody>
				...
				while ($isi = mysqli_fetch_object($result)) {
					...
					<tr>
						...
						<td><?= $isi-> prodi;?></td>
						<td>
							<a href="edit.php?nim=<?php echo $isi->nim; ?>" class="btn btn-warning">Edit</a>

							<a href="delete.php?nim=<?php echo $isi->nim; ?>"
	  		  			onclick="return confirm('Apakah yakin ingin menghapus data?')" class="btn btn-danger">Hapus</a>
	  		  	</td>
